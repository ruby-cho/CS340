...
let addGameGenreForm = document.getElementById('add-game-genre-form');
...
addGameGenreForm.addEventListener("submit", function (e) {
    ...
    xhttp.open("POST", "/addGameGenre", true);
...
addRowToTable = (data) => {
    ...
    let currentTable = document.getElementById("games-genres-table");
